 ...
 */
public class RecyclerAdapterUpcoming extends RecyclerView.Adapter<RecyclerAdapterUpcoming.UpcomingViewHolder> {

    Context context;
    List<Result> movieList;
    Result result;

    public RecyclerAdapterUpcoming(Context context, List<Result> movieList) {
    ...
    @NonNull
    @Override
    public RecyclerAdapterUpcoming.UpcomingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_movie,parent,false);
        return new RecyclerAdapterUpcoming.UpcomingViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerAdapterUpcoming.UpcomingViewHolder holder, int position) {
